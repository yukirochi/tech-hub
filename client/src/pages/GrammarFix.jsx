...
import { FaArrowLeft, FaCheckCircle, FaCheck, FaExclamationCircle, FaSpinner, FaCopy, FaDownload } from 'react-icons/fa';
...
function GrammarFix({ onBack }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setResult(data.corrected || data.error || 'No correction generated');
    } catch (err) {
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.download = `grammar-fixed-${Date.now()}.txt`;
